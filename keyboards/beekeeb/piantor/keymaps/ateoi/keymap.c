...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [4] = LAYOUT_split_3x6_3(
        KC_TILD,   KC_NO,   KC_NO,   KC_NO,         KC_NO,   KC_NO,                        KC_APP,  KC_INS,  KC_HOME, KC_PGUP,  KC_PSCR, KC_TRNS,
        QMKALTTAB, KC_NO,   KC_NO,   A(KC_D),       KC_NO,   KC_NO,                        KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_SCRL, KC_ENT,
        KC_TRNS,   KC_NO,   KC_NO,   ALGR(KC_COMM), KC_NO,   KC_NO,                        KC_NO,   KC_DEL,  KC_END,  KC_PGDN,  KC_PAUS, KC_RALT,
