...
tap_dance_action_t tap_dance_actions[] = {[TD_EL] = ACTION_TAP_DANCE_FN_ADVANCED_WITH_RELEASE(NULL, el_released, el_finished, el_reset), [TD_TO1_TO2] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, l_finished, l_reset)};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_split_3x6_3(
        KC_TRNS, KC_NO,   KC_NO,   KC_NO,     KC_NO,      KC_NO,                         KC_NO,   QMKLBRCC, QMKRBRCC, KC_NO,   KC_F12,  KC_TRNS,
    ...
    [4] = LAYOUT_split_3x6_3(
        KC_TRNS,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                            KC_APP,  KC_INS,  KC_HOME, KC_PGUP,  KC_PSCR, KC_TRNS,
        QMKALTTAB, KC_NO,   KC_NO,   QMKALTD, KC_NO,   KC_NO,                            KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_SCRL, KC_ENT,
        KC_TRNS,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                            KC_NO,   KC_DEL,  KC_END,  KC_PGDN,  KC_PAUS, KC_RALT,
                                              KC_TRNS, KC_TRNS, KC_TRNS,        QMKCENT, KC_TRNS, KC_TRNS
    )
    // clang-format on
};
...
static td_tap_t el_tap_state = {.is_press_action = true, .state = TD_NONE};
